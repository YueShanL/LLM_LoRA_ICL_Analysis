...
layers = [("3", root / "rq3_l3"), ("22", root / "rq3_l22"), ("28", root / "rq3_l28")]
report = [
    "# RQ3 last_word instruction -> lora patch report",
    "",
    "samples: 16; max_new_tokens: 20; source=instruction_only; target=lora_only",
    "",
]
...
out = root / "rq3_last_word_layers_3_22_28_report.md"
